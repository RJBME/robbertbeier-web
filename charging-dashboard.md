...
<style>
  ...
  :root { 
    --dash-bg: #ffffff; --dash-text: #2c3e50; --dash-border: #eaeaea; --card-bg: #ffffff; 
    --header-bg: #1a1a1a; --header-text: #ffffff; --table-head: #f9f9f9;
  }
  @media (prefers-color-scheme: dark) {
    :root { 
      --dash-bg: #1a1a1a; --dash-text: #f1f1f1; --dash-border: #333; --card-bg: #252525; 
      --header-bg: #000000; --header-text: #ffffff; --table-head: #2d2d2d;
    }
  }

  .dash-container { font-family: -apple-system, sans-serif; max-width: 1000px; margin: auto; color: var(--dash-text); background: var(--dash-bg); padding: 10px; border-radius: 12px; }
  .status-bar { display: flex; background: var(--header-bg); color: var(--header-text); padding: 20px; border-radius: 12px; justify-content: space-around; text-align: center; margin-bottom: 25px; }
  ...
  .card { background: var(--card-bg); border: 1px solid var(--dash-border); padding: 20px; border-radius: 12px; }
  ...
  /* Brand Pills - Pale Background, Dark Text */
  ...
  .badge-ea { background: #f9fbe7; color: #afb42b; }
...
<div class="dash-container">
  <div class="status-bar">
    ...
    <div class="status-item"><span class="status-label">Real Savings</span><span class="status-value" style="color: #2ecc71;">${{ total_kwh | times: 3.0 | divided_by: 23 | times: 2.50 | minus: total_cost | round: 0 }}</span></div>
  </div>
  ...
  <div class="card" style="padding: 0; overflow-x: auto;">
    ...
    <div style="padding: 20px; text-align: center;">
       <a href="/charging-history/" style="color: #3498db; font-weight: bold; text-decoration: none;">View Full History →</a>
    </div>
  </div>
</div>
