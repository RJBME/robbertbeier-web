...
NEW DETAIL FIELDS (added when missing, never overwrites existing values):
  start_date, start_time, end_time  — charge timing
  soc_start, soc_end, soc_added     — battery state
  miles_added                       — FordPass reported miles
  temperature_c, temperature_f      — ambient temp at charge start
                                      Run backfill_temperature.py to fill these in
